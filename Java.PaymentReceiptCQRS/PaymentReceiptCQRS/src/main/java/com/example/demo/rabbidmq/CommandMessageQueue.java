...
public class CommandMessageQueue {
	...
	public static void init() {
		...
		try {
		    ...
		    channel.basicConsume("Command.queue", autoAck, "myConsumerTag",
		         new DefaultConsumer(channel) {
		                 ...
		                 throws IOException
		             {
		                	 ...
		                	 JSONParser parser=new JSONParser();
								JSONObject obj=(JSONObject)parser.parse(message);
								  typeString=obj.get("type").toString();
									 ...
									 * phan gia message sang json
									 */
		                	 paymentReceipt = new Gson().fromJson(obj.get("data").toString(), PaymentReceiptCommand.class);
		                ...
		                PaymentReceiptView paymentView=ConvertModelCommandToView.convert(paymentReceipt);
		                 ...
		                 if(typeString.equals(EventType.UPDATE)) {
		                	 ...
		                	 if(mapErrMessage.get(paymentReceipt.getRefID())==null) {
		                		 ...
		                		 /*
		                		  * //có bản version trước bị lỗi vào lưu lại  trong map
		                		  * mesage.version == map.version  ==>  chính là gói tin đã được gửi trc đó=> lưu vào database,xóa trong map
		                		  *  mesage.version< map.version ==> gói tin này ko có ý nghĩa nữa => hủy gói  tin
		                		  * mesage.version>map.version ==>cập nhật lại map và yêu cầu gửi lại
		                		  * 
		                		  */
...
//				                			 mapErrMessage.put(paymentReceipt.getRefID(), paymentReceipt.getVersion());
		                 ...
		                 }else  if(typeString.equals(EventType.DELETE)) {
		                	 if(mapErrMessage.get(paymentReceipt.getRefID())==null) {
		                		 /*
